			...
			'<form name="emailForm" id="emailForm" action="#" onsubmit="return false;" method="post">
					<table width="100%" cellpadding="3">
						...
						<td colspan="2" align="center">
						  <input class="button" type="button" value="Send" onclick="javascript:jax.call(\'jomcomment\', \'jcxSendEmail\', jax.$(\'recipientEmail\').value, jax.$(\'senderName\').value, jax.$(\'senderEmail\').value, jax.$(\'senderSubject\').value, \'' . $uri . '\');">&nbsp;
