...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-9046520-1");
	...
	<body id="ff-<?php echo $fontfamily; ?>" class="<?php echo $fontstyle; ?> <?php echo $tstyle; ?>">
		...
		<div class="wrapper">
			...
			<div id="mainbody">
				<!-- begin header -->
				<div id="header">
					<a href="<?php echo $this->baseurl;?>" class="nounder"><img src="<?php echo $this->baseurl;?>/images/blank.png" border="0" alt="back to the home page" id="logo" /></a>
            ...
            <?php if ($this->countModules('footerMenu')) : ?>
				<div id="center">
				<div id="footerMenu">
					<jdoc:include type="modules" name="footerMenu" style="raw" />
				</div>
				</div>
			<?php endif; ?>
