	...
	onBlurEditableSelectInput : function() {
		...
		if (se) {
			if (se.previousSibling.value != '') {
				Editor.dom.addSelect(se.id, se.previousSibling.value, se.previousSibling.value);
				Editor.dom.getSelect(se.id, se.previousSibling.value);
			} else
				Editor.dom.getSelect(se.id, '');
