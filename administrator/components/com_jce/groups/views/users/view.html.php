...
class GroupsViewUsers extends JView
{
	function display($tpl = null)
	{
		...
		$filter_order		= $mainframe->getUserStateFromRequest( "$option.$type.$client.filter_order",		'filter_order',		'a.name',	'cmd' );
		$filter_order_Dir	= $mainframe->getUserStateFromRequest( "$option.$type.$client.filter_order_Dir",	'filter_order_Dir',	'',			'word' );
		$filter_type		= $mainframe->getUserStateFromRequest( "$option.$type.$client.filter_type",		'filter_type', 		0,			'string' );
