...
class JCEHelper {
	...
	function fixGroups(){
		...
		$query = "INSERT INTO `#__jce_groups` (`id`, `name`, `description`, `users`, `types`, `rows`, `plugins`, `published`, `ordering`, `checked_out`, `checked_out_time`, `params`) VALUES
	...
	function fixPlugins(){
		...
		$query = "INSERT INTO `#__jce_plugins` (`id`, `title`, `name`, `type`, `icon`, `layout`, `row`, `ordering`, `published`, `editable`, `elements`, `iscore`, `checked_out`, `checked_out_time`, `params`, `variables`) VALUES
		...
		(54, 'Read More', 'readmore', 'plugin', 'readmore', 'readmore', 4, 18, 1, 0, '', 1, 0, '0000-00-00 00:00:00', '', ''),
		...
		(58, 'TinyMCE 2.x Compatability', 'compat2x', 'plugin', '', '', 0, 9, 1, 0, '', 1, 0, '0000-00-00 00:00:00', '', ''),
